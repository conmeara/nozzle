...
tags:
  - "clippings"
---
[Skip Navigation](https://developer.apple.com/documentation/technologyoverviews/#app-main)
...
![An image of a Mac, iPad, and iPhone showing the Mount Fuji landmark in the Landmarks app.](https://docs-assets.developer.apple.com/published/f49b6d36f77a89efa6c02f4d798de4e5/adoption-guide-intoducing-liquid-glass-hero~dark%402x.png)
...
![A grid showing the Podcasts app icon in the six style variants: default, dark, clear (light), clear (dark), tinted (light), and tinted (dark).](https://docs-assets.developer.apple.com/published/1da2139166002d43d6eaea6c4b5d8563/adoption-guide-app-icons-render-modes~dark%402x.png)
...
![A screenshot of the Icon Composer app showing the Podcasts app icon in the default style.](https://docs-assets.developer.apple.com/published/05e91a7c448741f4c0c1611664a902a0/adoption-guide-icon-composer-overview~dark%402x.png)
...
[Play](https://developer.apple.com/documentation/technologyoverviews/#)

Slider

<video width="540"><source src="https://docs-assets.developer.apple.com/published/4806dea0258ea62471842c0fbf18e005/adoption-guide-segmented-control.mp4"></video>
...
![A screenshot of the bottom half of an iPhone showing a tab bar as it appears in iOS 18 and earlier.](https://docs-assets.developer.apple.com/published/922810680eff94475847ef2e1dd7f4a7/adoption-guide-tab-bar-before~dark%402x.png)

Before

![A screenshot of the bottom half of an iPhone showing a tab bar as it appears in the latest version of iOS. The search tab appears in its own section at the trailing end of the tab bar.](https://docs-assets.developer.apple.com/published/21834f72d3f16af6525fe0a262b638d9/adoption-guide-tab-bar-after~dark%402x.png)
...
![A screenshot of the bottom half of an iPhone showing a toolbar as it appears in iOS 18 and earlier.](https://docs-assets.developer.apple.com/published/740ae45498c055aa2fd4f95198e24228/adoption-guide-toolbar-before~dark%402x.png)

Before

![A screenshot of the bottom half of an iPhone showing a toolbar as it appears in the latest version of iOS.](https://docs-assets.developer.apple.com/published/56b8d518b8305779a47018f68ccb021b/adoption-guide-toolbar-after~dark%402x.png)
...
![A graphic that shows a toolbar with four buttons that all share a background: Undo, Redo, Markup, and More.](https://docs-assets.developer.apple.com/published/508f6d91c41664ac217e69421ca387a6/adoption-guide-toolbar-items-grouping-incorrect~dark%402x.png)

Incorrect

![A graphic that shows a toolbar with the four buttons split into two groupings according to their functions. The Undo and Redo buttons share a background, and the Markup and More buttons share a background.](https://docs-assets.developer.apple.com/published/8623944ce6a49de8bb370d70eb0c255b/adoption-guide-toolbar-items-grouping-correct~dark%402x.png)
...
![A screenshot of an iPhone showing a grouped list layout as it appears in iOS 18 and earlier.](https://docs-assets.developer.apple.com/published/7821c722006ff631e633ab385ba68387/adoption-guide-list-view-before~dark%402x.png)

Before

![A screenshot of an iPhone showing a grouped list layout as it appears in the latest version of iOS.](https://docs-assets.developer.apple.com/published/93ae9770973f71306e50fdcd5b1c522b/adoption-guide-list-view-after~dark%402x.png)
...
![A graphic of an iPad showing search in a toolbar in the upper trailing corner.](https://docs-assets.developer.apple.com/published/8be761a53564818ca777f49cb69b71ca/adoption-guide-ipad-deafult-search~dark%402x.png)

Search in a toolbar on iPad

![A graphic of an iPhone showing search in a toolbar at the bottom of the screen.](https://docs-assets.developer.apple.com/published/7591e908a373af2b92dd24ba25a8128a/adoption-guide-iphone-deafult-search~dark%402x.png)
...
Current page is Adopting Liquid Glass