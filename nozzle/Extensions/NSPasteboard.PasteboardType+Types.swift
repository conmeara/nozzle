...
extension NSPasteboard.PasteboardType: Defaults.Serializable {
  ...
  // https://github.com/conmeara/nozzle/issues/429#issuecomment-1182575226
  static let modified = NSPasteboard.PasteboardType(rawValue: "x.nspasteboard.ModifiedType")

  // Marks that copy was made from nozzle.
  static let fromnozzle = NSPasteboard.PasteboardType(rawValue: "org.conmeara.nozzle")
