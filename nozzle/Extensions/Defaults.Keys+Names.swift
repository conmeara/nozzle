...
extension Defaults.Keys {
  ...
  static let menuIcon = Key<MenuIcon>("menuIcon", default: .vlogo)
  ...
  static let pasteTemplate = Key<String>("pasteTemplate", default: "{prompt}\n{items}")
  ...
  static let windowSize = Key<NSSize>("windowSize", default: NSSize(width: 900, height: 680))
